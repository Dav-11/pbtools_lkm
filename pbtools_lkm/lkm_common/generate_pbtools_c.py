...
typedef void (*repeated_item_write_t)(struct pbtools_encoder_t *self_p, int index, void *items_p);

typedef int (*decoder_read_repeated_t)(struct pbtools_decoder_t *self_p, int wire_type, void *items_p, int index);

static void *decoder_heap_alloc(struct pbtools_decoder_t *self_p, size_t size, size_t alignemnt);
...
static int encoder_get_result(struct pbtools_encoder_t *self_p)
{
    ...
    if (self_p->pos >= 0) {
        ...
        memmove(self_p->buf_p, &self_p->buf_p[self_p->pos + 1], (size_t)length);
    } else {
        length = self_p->pos;
    }
...
static void encoder_write_tagged_varint(struct pbtools_encoder_t *self_p, int field_number, int wire_type, uint64_t value)
{
    if (value > 0) {
...
static void encoder_write_tagged_varint_always(struct pbtools_encoder_t *self_p, int field_number, int wire_type, uint64_t value)
{
    encoder_write_varint(self_p, value);
    encoder_write_tag(self_p, field_number, wire_type);
}
...
static void encoder_write_32_bit_value(struct pbtools_encoder_t *self_p, uint32_t value)
{
    uint8_t buf[4];
...
static void encoder_write_64_bit_value(struct pbtools_encoder_t *self_p, uint64_t value)
{
    uint8_t buf[8];
...
{
    encoder_write_tagged_varint(self_p, field_number, PBTOOLS_WIRE_TYPE_VARINT, (uint64_t) (int64_t) value);
}

void pbtools_encoder_write_int64(struct pbtools_encoder_t *self_p, int field_number, int64_t value)
{
    encoder_write_tagged_varint(self_p, field_number, PBTOOLS_WIRE_TYPE_VARINT, (uint64_t) value);
}

void pbtools_encoder_write_sint32(struct pbtools_encoder_t *self_p, int field_number, int32_t value)
{
    pbtools_encoder_write_sint64(self_p, field_number, value);
}

void pbtools_encoder_write_sint64(struct pbtools_encoder_t *self_p, int field_number, int64_t value)
{
    pbtools_encoder_write_uint64(self_p, field_number, sint64_encode(value));
}

void pbtools_encoder_write_uint32(struct pbtools_encoder_t *self_p, int field_number, uint32_t value)
{
    pbtools_encoder_write_uint64(self_p, field_number, value);
}

void pbtools_encoder_write_uint64(struct pbtools_encoder_t *self_p, int field_number, uint64_t value)
{
    encoder_write_tagged_varint(self_p, field_number, PBTOOLS_WIRE_TYPE_VARINT, value);
}

void pbtools_encoder_write_fixed32(struct pbtools_encoder_t *self_p, int field_number, uint32_t value)
{
    if (value != 0) {
        encoder_write_32_bit_value(self_p, value);
        encoder_write_tag(self_p, field_number, PBTOOLS_WIRE_TYPE_32_BIT);
    }
}

void pbtools_encoder_write_fixed64(struct pbtools_encoder_t *self_p, int field_number, uint64_t value)
{
    if (value != 0) {
        encoder_write_64_bit_value(self_p, value);
        encoder_write_tag(self_p, field_number, PBTOOLS_WIRE_TYPE_64_BIT);
    }
}

void pbtools_encoder_write_sfixed32(struct pbtools_encoder_t *self_p, int field_number, int32_t value)
{
    pbtools_encoder_write_fixed32(self_p, field_number, (uint32_t) value);
}

void pbtools_encoder_write_sfixed64(struct pbtools_encoder_t *self_p, int field_number, int64_t value)
{
...
void pbtools_encoder_write_bool(struct pbtools_encoder_t *self_p, int field_number, bool value)
{
    if (value) {
...
void pbtools_encoder_write_enum(struct pbtools_encoder_t *self_p, int field_number, int value)
{
    pbtools_encoder_write_int32(self_p, field_number, value);
}

void pbtools_encoder_write_string(struct pbtools_encoder_t *self_p,
                  int field_number, char *value_p)
{
    size_t length;
    ...
    if (length > 0) {
        ...
        encoder_write_tagged_varint(self_p,
                        field_number,
                        PBTOOLS_WIRE_TYPE_LENGTH_DELIMITED, length);
    }
}

void pbtools_encoder_write_bytes(struct pbtools_encoder_t *self_p,
                 int field_number, struct pbtools_bytes_t *value_p)
{
    if (value_p->size > 0) {
        encoder_write(self_p, value_p->buf_p, (int)value_p->size);
        encoder_write_tagged_varint(self_p,
                        field_number,
                        PBTOOLS_WIRE_TYPE_LENGTH_DELIMITED, value_p->size);
    }
}
                    ...
                    int field_number, int64_t value)
{
    encoder_write_tagged_varint_always(self_p,
                       field_number,
                       PBTOOLS_WIRE_TYPE_VARINT, (uint64_t) value);
}
...
{
    encoder_write_tagged_varint_always(self_p,
                       field_number, PBTOOLS_WIRE_TYPE_VARINT, value);
}
...
static void write_repeated_float(struct pbtools_encoder_t *self_p, int index, float *items_p)
{
    uint32_t data;
...
static void write_repeated_double(struct pbtools_encoder_t *self_p, int index, double *items_p)
{
    uint64_t data;
...
static void write_repeated_bool(struct pbtools_encoder_t *self_p, int index, bool *items_p)
{
    if (items_p[index]) {
...
void pbtools_encoder_write_repeated_int32(struct pbtools_encoder_t *self_p,
                      int field_number,
...
void pbtools_encoder_write_repeated_int64(struct pbtools_encoder_t *self_p,
                      int field_number,
...
void pbtools_encoder_write_repeated_sint32(struct pbtools_encoder_t *self_p,
                       int field_number,
                       struct pbtools_repeated_int32_t *repeated_p)
{
    encoder_write_repeated(self_p,
...
void pbtools_encoder_write_repeated_sint64(struct pbtools_encoder_t *self_p,
                       int field_number,
                       struct pbtools_repeated_int64_t *repeated_p)
{
    encoder_write_repeated(self_p,
...
void pbtools_encoder_write_repeated_uint32(struct pbtools_encoder_t *self_p,
                       int field_number,
...
void pbtools_encoder_write_repeated_uint64(struct pbtools_encoder_t *self_p,
                       int field_number,
...
void pbtools_encoder_write_repeated_fixed32(struct pbtools_encoder_t *self_p,
                        int field_number,
                        struct pbtools_repeated_uint32_t *repeated_p)
{
    encoder_write_repeated(self_p,
...
void pbtools_encoder_write_repeated_fixed64(struct pbtools_encoder_t *self_p,
                        int field_number,
                        struct pbtools_repeated_uint64_t *repeated_p)
{
    encoder_write_repeated(self_p,
...
void pbtools_encoder_write_repeated_sfixed32(struct pbtools_encoder_t *self_p,
                         int field_number,
                         struct pbtools_repeated_int32_t *repeated_p)
{
    encoder_write_repeated(self_p,
...
void pbtools_encoder_write_repeated_sfixed64(struct pbtools_encoder_t *self_p,
                         int field_number,
                         struct pbtools_repeated_int64_t *repeated_p)
{
    encoder_write_repeated(self_p,
...
void pbtools_encoder_write_repeated_float(struct pbtools_encoder_t *self_p,
                      int field_number,
...
void pbtools_encoder_write_repeated_double(struct pbtools_encoder_t *self_p,
                       int field_number,
...
void pbtools_encoder_write_repeated_bool(struct pbtools_encoder_t *self_p,
                     int field_number,
...
void pbtools_encoder_write_repeated_string(struct pbtools_encoder_t *self_p,
                       int field_number,
                       struct pbtools_repeated_string_t *repeated_p)
{
    ...
    for (i = repeated_p->length - 1; i >= 0; i--) {
        ...
        encoder_write(self_p, (uint8_t *) repeated_p->items_pp[i], (int)length);
        encoder_write_length_delimited(self_p, field_number, length);
    }
}

void pbtools_encoder_write_repeated_bytes(struct pbtools_encoder_t *self_p,
                      int field_number,
                      struct pbtools_repeated_bytes_t *repeated_p)
{
    ...
    for (i = repeated_p->length - 1; i >= 0; i--) {
        encoder_write(self_p,
                  repeated_p->items_p[i].buf_p, (int)repeated_p->items_p[i].size);
        encoder_write_length_delimited(self_p,
                           field_number, repeated_p->items_p[i].size);
    }
}

static void decoder_init(struct pbtools_decoder_t *self_p,
             const uint8_t *buf_p, size_t size, struct pbtools_heap_t *heap_p)
{
    self_p->buf_p = buf_p;
    self_p->size = (int)size;
    self_p->pos = 0;
...
static void repeated_info_init_decode(struct pbtools_repeated_info_t *self_p,
                      struct pbtools_decoder_t *decoder_p, int wire_type)
{
    if (self_p->length == 0) {
...
static void decoder_read(struct pbtools_decoder_t *self_p, uint8_t *buf_p, size_t size)
{
...
static uint64_t read_varint_check_wire_type(struct pbtools_decoder_t *self_p,
                        int wire_type, int expected_wire_type)
{
...
static uint64_t read_varint_check_wire_type_varint(struct pbtools_decoder_t *self_p,
                           int wire_type)
{
    return read_varint_check_wire_type(self_p, wire_type, PBTOOLS_WIRE_TYPE_VARINT);
}
...
static uint64_t decoder_read_length_delimited(struct pbtools_decoder_t *self_p, int wire_type)
{
    ...
    length = read_varint_check_wire_type(self_p,
                         wire_type, PBTOOLS_WIRE_TYPE_LENGTH_DELIMITED);
...
int pbtools_decoder_read_tag(struct pbtools_decoder_t *self_p, int *wire_type_p)
{
    uint32_t value;
    int field_number;
...
int32_t pbtools_decoder_read_int32(struct pbtools_decoder_t *self_p, int wire_type)
{
    return (int32_t) pbtools_decoder_read_int64(self_p, wire_type);
}

int64_t pbtools_decoder_read_int64(struct pbtools_decoder_t *self_p, int wire_type)
{
    return (int64_t) read_varint_check_wire_type_varint(self_p, wire_type);
}

int32_t pbtools_decoder_read_sint32(struct pbtools_decoder_t *self_p, int wire_type)
{
    return (int32_t) pbtools_decoder_read_sint64(self_p, wire_type);
}

int64_t pbtools_decoder_read_sint64(struct pbtools_decoder_t *self_p, int wire_type)
{
    return sint64_decode(read_varint_check_wire_type_varint(self_p, wire_type));
}

uint32_t pbtools_decoder_read_uint32(struct pbtools_decoder_t *self_p, int wire_type)
{
    return (uint32_t) pbtools_decoder_read_uint64(self_p, wire_type);
}

uint64_t pbtools_decoder_read_uint64(struct pbtools_decoder_t *self_p, int wire_type)
{
...
uint32_t pbtools_decoder_read_fixed32(struct pbtools_decoder_t *self_p, int wire_type)
{
...
uint64_t pbtools_decoder_read_fixed64(struct pbtools_decoder_t *self_p, int wire_type)
{
...
int32_t pbtools_decoder_read_sfixed32(struct pbtools_decoder_t *self_p, int wire_type)
{
    return (int32_t) pbtools_decoder_read_fixed32(self_p, wire_type);
}

int64_t pbtools_decoder_read_sfixed64(struct pbtools_decoder_t *self_p, int wire_type)
{
...
bool pbtools_decoder_read_bool(struct pbtools_decoder_t *self_p, int wire_type)
{
    return (pbtools_decoder_read_int32(self_p, wire_type) != 0);
}

int pbtools_decoder_read_enum(struct pbtools_decoder_t *self_p, int wire_type)
{
    return pbtools_decoder_read_int32(self_p, wire_type);
}

void pbtools_decoder_read_string(struct pbtools_decoder_t *self_p,
                 int wire_type, char **value_pp)
{
    uint64_t size;

    size = decoder_read_length_delimited(self_p, wire_type);
    *value_pp = decoder_heap_alloc(self_p, size + 1, __alignof__(char));
...
void pbtools_decoder_read_bytes(struct pbtools_decoder_t *self_p,
                int wire_type, struct pbtools_bytes_t *bytes_p)
{
    uint64_t size;

    size = decoder_read_length_delimited(self_p, wire_type);
    bytes_p->size = size;
    bytes_p->buf_p = decoder_heap_alloc(self_p, bytes_p->size, __alignof__(uint8_t));
...
static void repeated_info_decode_length_delimited(struct pbtools_repeated_info_t *self_p,
...
static int decoder_read_repeated(struct pbtools_decoder_t *self_p,
                 int wire_type,
                 void *items_p,
                 repeated_item_read_t item_read, int item_wire_type)
{
    int size;
    struct pbtools_decoder_t decoder;
    int index;
...
static int decoder_read_repeated_varint(struct pbtools_decoder_t *self_p,
                    int wire_type,
                    void *items_p, repeated_item_read_t item_read)
{
    return (decoder_read_repeated(self_p,
                      wire_type,
                      items_p, item_read, PBTOOLS_WIRE_TYPE_VARINT));
}
                    ...
                    void *items_p, repeated_item_read_t item_read)
{
    return (decoder_read_repeated(self_p,
                      wire_type,
                      items_p, item_read, PBTOOLS_WIRE_TYPE_32_BIT));
}
                    ...
                    void *items_p, repeated_item_read_t item_read)
{
    return (decoder_read_repeated(self_p,
                      wire_type,
                      items_p, item_read, PBTOOLS_WIRE_TYPE_64_BIT));
}

static int calloc_repeated(struct pbtools_message_base_t *self_p,
               int length,
               struct pbtools_repeated_message_t *repeated_p, size_t item_size)
{
    size_t size;

    size = (item_size *(size_t)length);
    repeated_p->items_p = heap_alloc(self_p->heap_p, size, __alignof__(uint64_t));
...
static int alloc_repeated_int32(struct pbtools_message_base_t *self_p,
                int length, struct pbtools_repeated_int32_t *repeated_p)
{
...
static int alloc_repeated_uint32(struct pbtools_message_base_t *self_p,
                 int length, struct pbtools_repeated_uint32_t *repeated_p)
{
    return (calloc_repeated(self_p,
                length,
                (struct pbtools_repeated_message_t *)repeated_p,
...
static int alloc_repeated_int64(struct pbtools_message_base_t *self_p,
                int length, struct pbtools_repeated_int64_t *repeated_p)
{
    return (calloc_repeated(self_p,
                length,
                (struct pbtools_repeated_message_t *)repeated_p,
...
static int alloc_repeated_uint64(struct pbtools_message_base_t *self_p,
                 int length, struct pbtools_repeated_uint64_t *repeated_p)
{
    return (calloc_repeated(self_p,
                length,
                (struct pbtools_repeated_message_t *)repeated_p,
...
static bool are_more_items_to_decode(struct pbtools_repeated_info_t *repeated_info_p, int pos)
{
    return (pbtools_decoder_available(&repeated_info_p->decoder)
        && (pos < repeated_info_p->length));
}

static void decoder_decode_repeated(struct pbtools_decoder_t *self_p,
                    struct pbtools_repeated_info_t *repeated_info_p,
                    struct pbtools_repeated_message_t *repeated_p,
                    size_t item_size, decoder_read_repeated_t read_repeated)
{
    int res;
    int wire_type;
    int tag;
    ...
    repeated_p->items_p = decoder_heap_alloc(self_p,
    ...
    index = read_repeated(&repeated_info_p->decoder,
                  repeated_info_p->wire_type, repeated_p->items_p, 0);
    ...
    while (are_more_items_to_decode(repeated_info_p, index)) {
        ...
        if (tag == repeated_info_p->tag) {
            index += read_repeated(&repeated_info_p->decoder,
                           wire_type, repeated_p->items_p, index);
        } else {
...
static void read_repeated_bool_item(struct pbtools_decoder_t *self_p, bool *items_p, int index)
{
    items_p[index] = (bool)decoder_read_varint(self_p);
}

static void read_repeated_float_item(struct pbtools_decoder_t *self_p,
                     float *items_p, int index)
{
    uint32_t data;
...
static int read_repeated_int32(struct pbtools_decoder_t *self_p,
                   int wire_type, int32_t *items_p, int index)
{
    return (decoder_read_repeated_varint(self_p,
                         wire_type,
                         &items_p[index],
...
static int read_repeated_int64(struct pbtools_decoder_t *self_p,
                   int wire_type, int64_t *items_p, int index)
{
    return (decoder_read_repeated_varint(self_p,
                         wire_type,
                         &items_p[index],
...
static int read_repeated_uint32(struct pbtools_decoder_t *self_p,
                int wire_type, uint32_t *items_p, int index)
{
    return (decoder_read_repeated_varint(self_p,
                         wire_type, &items_p[index], (repeated_item_read_t)
                         read_repeated_uint32_item));
}

static int read_repeated_uint64(struct pbtools_decoder_t *self_p,
                int wire_type, uint64_t *items_p, int index)
{
    return (decoder_read_repeated_varint(self_p,
                         wire_type, &items_p[index], (repeated_item_read_t)
                         read_repeated_uint64_item));
}
                ...
                int wire_type, int64_t *items_p, int index)
{
    return (decoder_read_repeated_varint(self_p,
                         wire_type, &items_p[index], (repeated_item_read_t)
                         read_repeated_sint64_item));
}

static int read_repeated_fixed32(struct pbtools_decoder_t *self_p,
                 int wire_type, uint32_t *items_p, int index)
{
    return (decoder_read_repeated_32_bit(self_p,
                         wire_type, &items_p[index], (repeated_item_read_t)
                         read_repeated_fixed32_item));
}

static int read_repeated_fixed64(struct pbtools_decoder_t *self_p,
                 int wire_type, uint64_t *items_p, int index)
{
    return (decoder_read_repeated_64_bit(self_p,
                         wire_type, &items_p[index], (repeated_item_read_t)
                         read_repeated_fixed64_item));
}
                  ...
                  int wire_type, int64_t *items_p, int index)
{
    return (decoder_read_repeated_64_bit(self_p,
                         wire_type, &items_p[index], (repeated_item_read_t)
                         read_repeated_sfixed64_item));
}

static int read_repeated_float(struct pbtools_decoder_t *self_p,
                   int wire_type, float *items_p, int index)
{
    return (decoder_read_repeated_32_bit(self_p,
                         wire_type,
                         &items_p[index],
...
static int read_repeated_double(struct pbtools_decoder_t *self_p,
                int wire_type, double *items_p, int index)
{
    return (decoder_read_repeated_64_bit(self_p,
                         wire_type, &items_p[index], (repeated_item_read_t)
                         read_repeated_double_item));
}

static int read_repeated_bool(struct pbtools_decoder_t *self_p,
                  int wire_type, bool *items_p, int index)
{
    return (decoder_read_repeated_varint(self_p,
                         wire_type,
                         &items_p[index],
...
static int read_repeated_string(struct pbtools_decoder_t *self_p,
                int wire_type, char **items_pp, int index)
{
...
static int read_repeated_bytes(struct pbtools_decoder_t *self_p,
                   int wire_type, struct pbtools_bytes_t *items_p, int index)
{
...
void pbtools_decoder_decode_repeated_int32(struct pbtools_decoder_t *self_p,
                       struct pbtools_repeated_info_t *repeated_info_p,
                       struct pbtools_repeated_int32_t *repeated_p)
{
...
void pbtools_decoder_decode_repeated_int64(struct pbtools_decoder_t *self_p,
                       struct pbtools_repeated_info_t *repeated_info_p,
                       struct pbtools_repeated_int64_t *repeated_p)
{
    decoder_decode_repeated(self_p,
...
void pbtools_decoder_decode_repeated_uint32(struct pbtools_decoder_t *self_p,
                        struct pbtools_repeated_info_t *repeated_info_p,
                        struct pbtools_repeated_uint32_t *repeated_p)
{
    decoder_decode_repeated(self_p,
...
void pbtools_decoder_decode_repeated_uint64(struct pbtools_decoder_t *self_p,
                        struct pbtools_repeated_info_t *repeated_info_p,
                        struct pbtools_repeated_uint64_t *repeated_p)
{
    decoder_decode_repeated(self_p,
...
void pbtools_decoder_decode_repeated_sint32(struct pbtools_decoder_t *self_p,
                        struct pbtools_repeated_info_t *repeated_info_p,
                        struct pbtools_repeated_int32_t *repeated_p)
{
    decoder_decode_repeated(self_p,
...
void pbtools_decoder_decode_repeated_sint64(struct pbtools_decoder_t *self_p,
                        struct pbtools_repeated_info_t *repeated_info_p,
                        struct pbtools_repeated_int64_t *repeated_p)
{
    decoder_decode_repeated(self_p,
...
void pbtools_decoder_decode_repeated_fixed32(struct pbtools_decoder_t *self_p,
                         struct pbtools_repeated_info_t *repeated_info_p,
                         struct pbtools_repeated_uint32_t *repeated_p)
{
    decoder_decode_repeated(self_p,
...
void pbtools_decoder_decode_repeated_fixed64(struct pbtools_decoder_t *self_p,
                         struct pbtools_repeated_info_t *repeated_info_p,
                         struct pbtools_repeated_uint64_t *repeated_p)
{
    decoder_decode_repeated(self_p,
...
void pbtools_decoder_decode_repeated_sfixed32(struct pbtools_decoder_t *self_p,
                          struct pbtools_repeated_info_t *repeated_info_p,
                          struct pbtools_repeated_int32_t *repeated_p)
{
    decoder_decode_repeated(self_p,
...
void pbtools_decoder_decode_repeated_sfixed64(struct pbtools_decoder_t *self_p,
                          struct pbtools_repeated_info_t *repeated_info_p,
                          struct pbtools_repeated_int64_t *repeated_p)
{
    decoder_decode_repeated(self_p,
...
int pbtools_alloc_repeated_float(struct pbtools_message_base_t *self_p,
                 int length, struct pbtools_repeated_float_t *repeated_p)
{
    return (calloc_repeated(self_p,
                length,
                (struct pbtools_repeated_message_t *)repeated_p,
...
void pbtools_decoder_decode_repeated_float(struct pbtools_decoder_t *self_p,
                       struct pbtools_repeated_info_t *repeated_info_p,
                       struct pbtools_repeated_float_t *repeated_p)
{
    decoder_decode_repeated(self_p,
                repeated_info_p,
                (struct pbtools_repeated_message_t *)repeated_p,
                sizeof(float), (decoder_read_repeated_t) read_repeated_float);
}

int pbtools_alloc_repeated_double(struct pbtools_message_base_t *self_p,
                  int length, struct pbtools_repeated_double_t *repeated_p)
{
    return (calloc_repeated(self_p,
                length,
                (struct pbtools_repeated_message_t *)repeated_p,
...
void pbtools_decoder_decode_repeated_double(struct pbtools_decoder_t *self_p,
                        struct pbtools_repeated_info_t *repeated_info_p,
                        struct pbtools_repeated_double_t *repeated_p)
{
    decoder_decode_repeated(self_p,
...
int pbtools_alloc_repeated_bool(struct pbtools_message_base_t *self_p,
                int length, struct pbtools_repeated_bool_t *repeated_p)
{
    return (calloc_repeated(self_p,
                length,
                (struct pbtools_repeated_message_t *)repeated_p,
...
void pbtools_decoder_decode_repeated_bool(struct pbtools_decoder_t *self_p,
                      struct pbtools_repeated_info_t *repeated_info_p,
                      struct pbtools_repeated_bool_t *repeated_p)
{
    decoder_decode_repeated(self_p,
                repeated_info_p,
                (struct pbtools_repeated_message_t *)repeated_p,
                sizeof(bool), (decoder_read_repeated_t) read_repeated_bool);
}

int pbtools_alloc_repeated_string(struct pbtools_message_base_t *self_p,
                  int length, struct pbtools_repeated_string_t *repeated_p)
{
    int pos;
...
void pbtools_decoder_decode_repeated_string(struct pbtools_decoder_t *self_p,
                        struct pbtools_repeated_info_t *repeated_info_p,
                        struct pbtools_repeated_string_t *repeated_p)
{
    decoder_decode_repeated(self_p,
...
int pbtools_alloc_repeated_bytes(struct pbtools_message_base_t *self_p,
                 int length, struct pbtools_repeated_bytes_t *repeated_p)
{
    return (calloc_repeated(self_p,
                length,
                (struct pbtools_repeated_message_t *)repeated_p,
...
void pbtools_decoder_decode_repeated_bytes(struct pbtools_decoder_t *self_p,
                       struct pbtools_repeated_info_t *repeated_info_p,
                       struct pbtools_repeated_bytes_t *repeated_p)
{
    decoder_decode_repeated(self_p,
...
static void decoder_init_slice(struct pbtools_decoder_t *self_p,
                   struct pbtools_decoder_t *parent_p, int size)
{
...
void pbtools_decoder_skip_field(struct pbtools_decoder_t *self_p, int wire_type)
{
    uint64_t value;
              ...
              size_t message_size, pbtools_message_init_t message_init)
{
    ...
    self_p = heap_alloc(heap_p, message_size, __alignof__(struct pbtools_message_base_t));
...
int pbtools_message_encode(struct pbtools_message_base_t *self_p,
               uint8_t *encoded_p,
               size_t size, pbtools_message_encode_inner_t message_encode_inner)
{
...
int pbtools_message_decode(struct pbtools_message_base_t *self_p,
               ...
               size_t size, pbtools_message_decode_inner_t message_decode_inner)
{
    struct pbtools_decoder_t decoder;
...
int pbtools_sub_message_alloc(struct pbtools_message_base_t **message_pp,
                  struct pbtools_heap_t *heap_p,
                  size_t sub_message_size, pbtools_message_init_t message_init)
{
...
int pbtools_alloc_repeated(struct pbtools_repeated_message_t *repeated_p,
               int length,
               struct pbtools_heap_t *heap_p,
               size_t item_size, pbtools_message_init_t message_init)
{
    int i;
    char *item_p;

    repeated_p->items_p = heap_alloc(heap_p,
                     item_size *(size_t)length, __alignof__(uint64_t));
...
void pbtools_encode_repeated_inner(struct pbtools_encoder_t *encoder_p,
                   int field_number,
                   struct pbtools_repeated_message_t *repeated_p,
                   size_t item_size,
...
static void decode_repeated_inner_item(struct pbtools_repeated_info_t *repeated_info_p,
                       size_t item_size,
                       pbtools_message_decode_inner_t message_decode_inner,
                       char **item_pp, int *length_p)
{
    int size;
    struct pbtools_decoder_t decoder;
...
void pbtools_decode_repeated_inner(struct pbtools_decoder_t *decoder_p,
                   struct pbtools_repeated_info_t *repeated_info_p,
                   struct pbtools_repeated_message_t *repeated_p,
                   size_t item_size,
                   ...
                   pbtools_message_decode_inner_t message_decode_inner)
{
    ...
    res = pbtools_alloc_repeated(repeated_p,
                     ...
                     repeated_info_p->decoder.heap_p, item_size, message_init);
    ...
    decode_repeated_inner_item(repeated_info_p,
                   item_size, message_decode_inner, &item_p, &length);
    ...
    while (are_more_items_to_decode(repeated_info_p, length)) {
        ...
        if (tag == repeated_info_p->tag) {
            decode_repeated_inner_item(repeated_info_p,
                           item_size,
                           message_decode_inner, &item_p, &length);
        } else {
            pbtools_decoder_skip_field(&repeated_info_p->decoder, wire_type);
        }
    }
...
void pbtools_encoder_sub_message_encode(struct pbtools_encoder_t *self_p,
                    int field_number,
                    struct pbtools_message_base_t *message_p,
                    pbtools_message_encode_inner_t encode_inner)
{
    ...
    if (message_p != NULL) {
        ...
        encoder_write_length_delimited(self_p,
                           field_number, (uint64_t) (pos - self_p->pos));
    }
}

void pbtools_encoder_sub_message_encode_always(struct pbtools_encoder_t *self_p,
                           int field_number,
                           struct pbtools_message_base_t *message_p,
                           pbtools_message_encode_inner_t encode_inner)
{
...
void pbtools_decoder_sub_message_decode(struct pbtools_decoder_t *self_p,
                    int wire_type,
                    ...
                    pbtools_message_decode_inner_t decode_inner)
{
    ...
    message_p = decoder_heap_alloc(self_p,
                       sub_message_size,
                       __alignof__(struct pbtools_message_base_t));
