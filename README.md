...
To better understand some possible use cases for this library, it generates, alongside the protobuf serialization/deserialization code, an LKM stub that the user can use as a starting point for implementing his/her module.
